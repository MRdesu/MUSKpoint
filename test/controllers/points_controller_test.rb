...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post points_url, params: { point: { data_date: @point.data_date, email: @point.email, point_left: @point.point_left, product: @point.product, used_point: @point.used_point } }
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { data_date: @point.data_date, email: @point.email, point_left: @point.point_left, product: @point.product, used_point: @point.used_point } }
